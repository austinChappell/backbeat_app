          ...
          component={() => (
            <View style={styles.popoverContainer}>
              <Text style={styles.popoverText}>
                The BackBeat is not currently servicing your area. If you are interested in having
                us in {this.state.zipCity}, please contact us at support@thebackbeatproject.com.
              </Text>
            </View>
          )}
        >
          <TouchableOpacity
            onPress={() => this.setState({ popoverVisible: !this.state.popoverVisible })}
          >
            <Icon name="md-help-circle" type="ionicon" color="#ff0000" />
          </TouchableOpacity>
        </Popover>
      </View>
    ) : null;
